    ...
    <div class="col-md-12">
        <div class="card mb-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?= base_url("index.php/cart/delete/$row->id") ?>" method="POST">
                                    <input type="hidden" name="id" value="<?= $row->id ?>">
                                    <button class="btn btn-danger" type="submit" onclick="return confirm        ('Apakah yakin ingin menghapus?')"><i class="fas fa-trash-alt"></i>
                                    </button>
                                </form>
                            </td>
                        </tr>
            ...
            <div class="card-footer">
                <a href="<?= base_url('index.php/checkout') ?>" class="btn btn-success float-right">Pembayaran <i class="fas-fa-angle-right"></i></a>
